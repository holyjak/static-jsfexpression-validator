...
public class MyFaces21TagRepresentation implements TagRepresentation {

	private final Tag tag;
	private final String namespaceUrl;

	MyFaces21TagRepresentation(Tag tag, String namespaceUrl) {
		this.tag = tag;
	...
	public int getLocationLine() {
		return tag.getLocation().getLine();
	}
