...
/**
 * Copy of MyFaces CompilationManager, v2.1.1.
 * The only difference is that we report some events.
 */
public class JhCompilationManager {

    //private final static Logger log = Logger.getLogger("facelets.compiler");
    private final static Logger log = Logger.getLogger(JhCompilationManager.class.getName());
    ...
    public JhCompilationManager(String alias, Compiler compiler, FaceletsProcessingInstructions instructions)
    {
