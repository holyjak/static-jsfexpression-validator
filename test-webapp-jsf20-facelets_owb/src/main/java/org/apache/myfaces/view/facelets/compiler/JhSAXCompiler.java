...
/**
 * Copy of MyFaces SAXCompiler, v2.1.1.
 * The only difference is the usage of JhCompilationManager instead of
 * CompilationManager.
 */
public class JhSAXCompiler extends org.apache.myfaces.view.facelets.compiler.Compiler
{
    ...
    private static class CompilationHandler extends DefaultHandler implements LexicalHandler
    {
        ...
        private final JhCompilationManager unit;

        private boolean consumingCDATA = false;

        public CompilationHandler(JhCompilationManager unit, String alias)
        {
            this.unit = unit;
            this.alias = alias;
        }
    ...
    private static class ViewMetadataHandler extends DefaultHandler implements LexicalHandler
    {
        ...
        public ViewMetadataHandler(JhCompilationManager unit, String alias)
        {
            this.unit = unit;
            this.alias = alias;
        }
    ...
    private static class CompositeComponentMetadataHandler extends DefaultHandler implements LexicalHandler
    {
        ...
        public CompositeComponentMetadataHandler(JhCompilationManager unit, String alias)
        {
            this.unit = unit;
            this.alias = alias;
        }
    ...
    public FaceletHandler doCompile(URL src, String alias) throws IOException, FaceletException, ELException,
		    FacesException
    {
        JhCompilationManager mngr = null;
        InputStream is = null;
        String encoding = null;
        try
        {
            is = new BufferedInputStream(src.openStream(), 1024);
            mngr = new JhCompilationManager(alias, this, getFaceletsProcessingInstructions(src, alias));
    ...
    protected static final String writeXmlDecl(InputStream is, JhCompilationManager mngr) throws IOException
    {
        is.mark(128);
        String encoding = null;
        try
    ...
    protected static final String getXmlDecl(InputStream is, JhCompilationManager mngr) throws IOException
    {
        is.mark(128);
        String encoding = null;
        try
