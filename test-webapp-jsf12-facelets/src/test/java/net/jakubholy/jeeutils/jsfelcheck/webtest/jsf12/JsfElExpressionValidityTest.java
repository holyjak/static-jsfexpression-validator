...
import net.jakubholy.jeeutils.jsfelcheck.HelloWorldBacking;
    ...
    public void verify_all_el_expressions_valid() throws Exception {
        ...
        jsfStaticAnalyzer.withLocalVariablesConfiguration(
                ...
                .withManagedBeansAndVariablesConfiguration(
		                // We can't detect anotated mng beans yet so let's delcare it manually
		                forExtraVariables().withExtraVariable("helloWorldBacking", HelloWorldBacking.class))
                ;
	    ...
	    assertEquals("All the expected ELs should have been found and validated"
			    , 3, results.goodResults().size());

	    // TODO Copy exhaustive tests from test-webapp-jsf20-facelets_owb and use them here too
