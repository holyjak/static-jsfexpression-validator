...
/**
 * Copy of MyFaces SAXCompiler with slight adjustments, from MyFaces v1.2.10
 *
 * The differences are: 1) it uses {@link org.apache.myfaces.view.facelets.compiler.JsfelcheckCompilationManager}/
...
public final class JsfelcheckSAXCompiler extends Compiler
{
    ...
    public FaceletHandler doCompile(URL src, String alias) throws IOException,
        ...
        try {
            ...
            mngr = new NotifyingCompilationManager(alias, this, tagListener);
    ...
    protected static final String writeXmlDecl(InputStream is, JsfelcheckCompilationManager mngr)
            throws IOException {
        is.mark(128);
        String encoding = "UTF-8";
        try {
